...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Your personal life circle</title>
...
<link href="https://fonts.googleapis.com/css?family=Montserrat" rel="stylesheet">  
        ...
        <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBj3FIq8R2uet3vXbLp0BdWmMk4Ag23oos"></script>
</head>
...
<script type="text/javascript">
            ...
            function init() {
                var mapOptions = {
                    ...
                    // de coordinaten van jawi
                    center: new google.maps.LatLng(52.1279795, 4.64164), //Jawi
                ...
                var marker = new google.maps.Marker({
                    position: new google.maps.LatLng(52.1279795, 4.64164),
                    map: map,
                    title: 'YourPersonalLifeCircle'
                });
            }
        </script>
 ...
 <h1 class="text-center">Contact | Your Personal Life Circle</h1>          
...
<br>  
  ...
  <div class="row2">
    <div class="col-sm-6">
    <div id="titelcontact">
      <p><span class="glyphicon glyphicon-map-marker" style="color: #65a13e;"></span>Alphen aan den Rijn</p> 
          </div>
    <br> <br> 
          <div id="titelcontact2">
      <p><span class="glyphicon glyphicon-phone" style="color: #65a13e;"></span> 0628540425</p> 
          </div>
    <br><br> 
      <div id="titelcontact3">
      <p><span class="glyphicon glyphicon-envelope" style="color: #65a13e;"></span>Info@YourPersonaLifeCircle.nl</p>
            </div>
    <br> <br> 
        <div id="titelcontact4"> 
            
      <p>KvK-nummer:65498798</p> 
    </div>
    </div>
...
<div id="formbericht">
<textarea class="form-control" id="msg" name="msg" placeholder="Bericht" rows="9"></textarea><br>
          </div>
 <div class="row4">
   <div id="formsend">  
    <div class="col-dm-4 form-group">
